// Ionic Starter App
//var path = 'http://localhost/capsapp/capsapp/public/api/v1';
var path = 'http://178.62.32.109/capsapp/public/api/v1';
  ...
  .state('app.maps', {
    ...
    data: {
      ...
      .state('app.caps', {
          ...
          views: {
              'menuContent': {
                  templateUrl: "templates/caps.html",
                  controller: 'CapsCtrl'
              }
          },
          data: {
      ...
      .state('app.capsmake', {
          ...
          views: {
              'menuContent': {
                  templateUrl: "templates/capsmake.html",
                  controller: 'CapsMakeCtrl'
              }
          },
          data: {
              // authenticate: true
