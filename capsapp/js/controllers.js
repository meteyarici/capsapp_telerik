...
// MISCELLANEOUS
.controller('MiscellaneousCtrl', function($scope, $http, $ionicLoading) {
        ...
        $scope.doRefresh = function() {
            $http.get(path + '/catagories').success(function(data, status, headers, config) {


                //  var caps = _.find(response, {id: capsId });
                $scope.cats = data;
                $ionicLoading.hide();
...
//brings all caps
    .controller('CapsCtrl', function($scope, $http, $ionicLoading) {

//http://localhost/capsapp/capsapp/public/api/v1/caps
        ...
        $scope.doRefresh = function() {
            $http.get(path + '/caps').success(function(data, status, headers, config) {
...
//brings all caps
    .controller('CapsMakeCtrl', function($scope, $http) {
